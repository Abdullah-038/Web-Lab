# Laravel Product CRUD with Validation, Events, Storage, and DataTables
...
- image upload support using the public storage disk
- a DataTables-enhanced product listing
...
Product images are stored on the public disk and displayed from the storage symlink.

If this is placed in a real Laravel project, run:
